...
export class OnPrintShop implements INodeType {
		...
		properties: [
			...
			// Order: Get - Customer Fields
			{
				...
				options: [
					...
					{ name: 'Customer Zip', value: 'customer_zip' },
					{ name: 'Customer Country', value: 'customer_country' },
					{ name: 'Customer Company', value: 'customer_company' },
					{ name: 'Customer Notes', value: 'customer_notes' },
				],
				default: [
					'user_id',
					'corporate_id',
			...
			// Order: Get - Product Fields
			{
				...
				options: [
					...
					{ name: 'Product SKU', value: 'product_sku' },
					{ name: 'Product Description', value: 'product_description' },
					{ name: 'Product Price', value: 'product_price' },
					{ name: 'Product Quantity', value: 'product_quantity' },
					{ name: 'Product Weight', value: 'product_weight' },
					{ name: 'Product Category', value: 'product_category' },
					{ name: 'Product Brand', value: 'product_brand' },
					{ name: 'Product Color', value: 'product_color' },
					{ name: 'Product Size', value: 'product_size' },
					{ name: 'Product Material', value: 'product_material' },
					{ name: 'Product Finish', value: 'product_finish' },
					{ name: 'Product Orientation', value: 'product_orientation' },
					{ name: 'Product Sides', value: 'product_sides' },
					{ name: 'Product Binding', value: 'product_binding' },
					{ name: 'Product Folding', value: 'product_folding' },
					{ name: 'Product Lamination', value: 'product_lamination' },
					{ name: 'Product Perforation', value: 'product_perforation' },
					{ name: 'Product Hole Punching', value: 'product_hole_punching' },
					{ name: 'Product Corner Rounding', value: 'product_corner_rounding' },
					{ name: 'Product UV Coating', value: 'product_uv_coating' },
					{ name: 'Product Spot UV', value: 'product_spot_uv' },
					{ name: 'Product Foil Stamping', value: 'product_foil_stamping' },
					{ name: 'Product Embossing', value: 'product_embossing' },
					{ name: 'Product Debossing', value: 'product_debossing' },
					{ name: 'Product Die Cutting', value: 'product_die_cutting' },
					{ name: 'Product Custom Size', value: 'product_custom_size' },
					{ name: 'Product Rush Order', value: 'product_rush_order' },
					{ name: 'Product Setup Fee', value: 'product_setup_fee' },
				],
				default: [
					'product_id',
					'product_name',
					...
					'product_lamination',
					'product_perforation',
					'product_hole_punching',
					'product_corner_rounding',
					'product_uv_coating',
					'product_spot_uv',
			...
			// Order: Get - Blind Detail Fields
			{
				...
				options: [
					...
					{ name: '🔘 Deselect All Fields', value: 'DESELECT_ALL' },
					{ name: '─────────────────────────────', value: 'SEPARATOR' },
					{ name: 'Blind Detail ID', value: 'blind_detail_id' },
					{ name: 'Blind Detail Name', value: 'blind_detail_name' },
					{ name: 'Blind Detail Company', value: 'blind_detail_company' },
					{ name: 'Blind Detail Address', value: 'blind_detail_address' },
					{ name: 'Blind Detail City', value: 'blind_detail_city' },
					{ name: 'Blind Detail State', value: 'blind_detail_state' },
					{ name: 'Blind Detail Zip', value: 'blind_detail_zip' },
					{ name: 'Blind Detail Country', value: 'blind_detail_country' },
					{ name: 'Blind Detail Phone', value: 'blind_detail_phone' },
				],
				default: [
					'blind_detail_id',
					'blind_detail_name',
					'blind_detail_company',
					'blind_detail_address',
					'blind_detail_city',
					'blind_detail_state',
					'blind_detail_zip',
					'blind_detail_country',
					'blind_detail_phone',
				],
			...
			// Order: Get - Delivery Detail Fields
			{
				...
				options: [
					...
					{ name: '🔘 Deselect All Fields', value: 'DESELECT_ALL' },
					{ name: '─────────────────────────────', value: 'SEPARATOR' },
					{ name: 'Delivery Detail ID', value: 'delivery_detail_id' },
					{ name: 'Delivery Detail Name', value: 'delivery_detail_name' },
					{ name: 'Delivery Detail Company', value: 'delivery_detail_company' },
					{ name: 'Delivery Detail Address', value: 'delivery_detail_address' },
					{ name: 'Delivery Detail City', value: 'delivery_detail_city' },
					{ name: 'Delivery Detail State', value: 'delivery_detail_state' },
					{ name: 'Delivery Detail Zip', value: 'delivery_detail_zip' },
					{ name: 'Delivery Detail Country', value: 'delivery_detail_country' },
					{ name: 'Delivery Detail Phone', value: 'delivery_detail_phone' },
					{ name: 'Delivery Detail Email', value: 'delivery_detail_email' },
					{ name: 'Delivery Detail Notes', value: 'delivery_detail_notes' },
				],
				default: [
					'delivery_detail_id',
					'delivery_detail_name',
					'delivery_detail_company',
					'delivery_detail_address',
					'delivery_detail_city',
					'delivery_detail_state',
					'delivery_detail_zip',
					'delivery_detail_country',
					'delivery_detail_phone',
					'delivery_detail_email',
					'delivery_detail_notes',
				],
			...
			// Order: Get - Billing Detail Fields
			{
				...
				options: [
					...
					{ name: '🔘 Deselect All Fields', value: 'DESELECT_ALL' },
					{ name: '─────────────────────────────', value: 'SEPARATOR' },
					{ name: 'Billing Detail ID', value: 'billing_detail_id' },
					{ name: 'Billing Detail Name', value: 'billing_detail_name' },
					{ name: 'Billing Detail Company', value: 'billing_detail_company' },
					{ name: 'Billing Detail Address', value: 'billing_detail_address' },
					{ name: 'Billing Detail City', value: 'billing_detail_city' },
					{ name: 'Billing Detail State', value: 'billing_detail_state' },
					{ name: 'Billing Detail Zip', value: 'billing_detail_zip' },
					{ name: 'Billing Detail Country', value: 'billing_detail_country' },
					{ name: 'Billing Detail Phone', value: 'billing_detail_phone' },
					{ name: 'Billing Detail Email', value: 'billing_detail_email' },
					{ name: 'Billing Detail Notes', value: 'billing_detail_notes' },
				],
				default: [
					'billing_detail_id',
					'billing_detail_name',
					'billing_detail_company',
					'billing_detail_address',
					'billing_detail_city',
			...
			// Order: Get - Shipment Detail Fields
			{
				...
				options: [
					...
					{ name: '🔘 Deselect All Fields', value: 'DESELECT_ALL' },
					{ name: '─────────────────────────────', value: 'SEPARATOR' },
					{ name: 'Shipment Detail ID', value: 'shipment_detail_id' },
					{ name: 'Shipment Detail Tracking', value: 'shipment_detail_tracking' },
					{ name: 'Shipment Detail Carrier', value: 'shipment_detail_carrier' },
					{ name: 'Shipment Detail Status', value: 'shipment_detail_status' },
					{ name: 'Shipment Detail Date', value: 'shipment_detail_date' },
				],
				default: [
					'shipment_detail_id',
					'shipment_detail_tracking',
					'shipment_detail_carrier',
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		for (let i = 0; i < items.length; i++) {
			try {
				...
				if (resource === 'order' && operation === 'get') {
					...
					const variables: IDataObject = { id: orderId };
		...
		if (resource === 'product' && operation === 'getManyFAQs') {
			...
			let limit: number = typeof queryParameters.limit === 'number' ? queryParameters.limit : 50;
			let offset: number = typeof queryParameters.offset === 'number' ? queryParameters.offset : 0;
